...
puts "Réponse à la question 2 : #{j}"
...
puts "Réponse à la question 3 : #{j}"

print "Seconde façon de résoudre la question : "
puts tab.grep(/aude/i).length

print "Réponse à la question 4 : "
puts tab.grep(/@[[:upper:]]/).length
...
tab.each{|underscore|i += underscore.count "_"}
puts "#{i}"
#underscore = ma variable, j'incremente i, je compte ma variable, ma variable vaut : _

print "Réponse à la question 7 : "
puts tab.sort_by {|m| m.downcase}
#après avoir classé une lettre par ordre ascii (les majuscule d'abord donc), il classe à la suite la minuscule correpondante
